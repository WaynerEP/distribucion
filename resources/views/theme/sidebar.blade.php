     ...
     <nav id="sidebar">
         ...
         <ul class="navbar-nav theme-brand flex-row  text-center">
             <li class="nav-item theme-text">
                 <a href="home" class="nav-link"> AM'U </a>
             </li>
         ...
         <ul class="list-unstyled menu-categories ps ps--active-y" id="accordionExample">
             <li class="menu {{ Route::currentRouteName('home')? 'active':'' }}">
                 <a href="home" aria-expanded="{{ Route::currentRouteName('home')? 'true':'false' }}" class="dropdown-toggle">
                     <div class="">
                         <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
             ...
             <div class="ps__rail-y" style="top: 0px; height: 185px; right: 0px;">
