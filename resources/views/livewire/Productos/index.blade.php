                            ...
                            <div class="card  mb-3">
                                <div class="card-body">
                                   <div class="text-center">
                                    <img src="{{ asset('storage/products/' . $product->image) }}" class="w-75 h-75">
                                   </div>

                                    <p class="mb-0 card-title"><b>{{ $product->nombre }}</b></p>
                                    <p class="mb-0 card-text">{{ $product->categoria }}</p>
                                    <p class="text-sm card-text ">Stock: {{ $product->cantidad }}</p>
                                    <div class="my-3">
                                        <h5 class="text-danger"><b>S/. {{ $product->precio }}</b></h5>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <div><a href="javascript:void(0);" class="text-success">
                                            <svg
            ...
            @else
                <div class="row">
                    <div class="col-12 text-center text-danger my-3 py-3">
                        No se encontraron resultados!! Lo siento Beba!!
                    </div>
                </div>
            @endif
            <div>
