    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ $title ? 'Editar Categoria' : 'Nueva Categoria' }}
                </h5>
            ...
            <div class="modal-body">
                <div class="form-group mb-4">
                    ...
                    <input type="text" wire:model.defer="nombre" class="form-control form-control-sm" id="nombre"
