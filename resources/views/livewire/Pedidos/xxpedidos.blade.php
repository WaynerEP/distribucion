            ...
            <div class="invoice-detail-body">
                ...
                <div class="invoice-detail-title">
                    ...
                    <div class="invoice-logo">
                        <img alt="avatar" src="{{ asset('assets/img/logo.png') }}" class="img-fluid rounded w-50" />
                    </div>
                    <div class="invoice-title">
                        <div class="form-group mb-4">
                            <label for="number">N° Documento:</label>
                            <input type="text" wire:model="nroDocument" readonly class="form-control form-control-sm"
                        ...
                        <div class="col-xl-5 invoice-address-company">
                            ...
                            <div class="invoice-address-company-fields">
                                        ...
                                        @if ($searchEmployee)
                                            <div class="dropdown-menu show bg-light-success"
                                                ...
                                                @if (count($employees) > 0)
                                                    ...
                                                    @endforeach
                                                @else
                                                    <a class="dropdown-item" href="javascript:void(0);">No hay
                                                        resultados!🙁(</a>
                                                @endif
                                            </div>
                                        @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" wire:model="nameEmployee"
                                            class="form-control form-control-sm" id="company-name" placeholder="Name">
                                        @error('idEmployee')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" wire:model="dniEmployee" class="form-control form-control-sm"
                                            id="employee-document" placeholder="xxxxxx">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="invoice-address-client-fields">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 btn-group btn-group-lg show">
                                        <input type="text" wire:model="searchCustomer"
                                            class="form-control form-control-sm" placeholder="Search cliente here...">
                                        @if ($searchCustomer)
                                                ...
                                                @if (count($customers) > 0)
                                                    @foreach ($customers as $customer)
                                                        <a class="dropdown-item"
                                                            ...
                                                            {{ $customer->nombre }} {{ $customer->aPaterno }} -
                                                            {{ $customer->dni }}</a>
                                                    @endforeach
                                                @else
                                                    <a class="dropdown-item" href="javascript:void(0);">No hay
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" wire:model="clientNombre"
                                            class="form-control form-control-sm" id="client-email" placeholder="Name"
                                ...
                                <div class="form-group row">
                                    <label for="client-email"
                                        class="col-sm-3 col-form-label col-form-label-sm">Email</label>
                                    <div class="col-sm-9">
                                        <input type="text" wire:model="clientEmail" class="form-control form-control-sm"
                                            id="client-email" placeholder="name@gmail.com">
                                    </div>
                                </div>
                    ...
                    <div class="table-responsive do-nicescrol" style="max-height: 450px; overflow: auto;">
                        <table class="table table-bordered item-table">
                            ...
                            <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="description">
                                                <input type="text" class="form-control form-control-sm"
                                                    value="{{ $orderProducts[$index]['nombre'] }}" name="product"
                                            ...
                                            <td class="text-center text-primary amount align-items-center">
                                                <span class="editable-amount"><span class="currency">S/.</span>
                                                    <span
                                ...
                                @else
                                    <tr>
                                        <td class="text-center" colspan="6">Seleccione producto a agregar al Pedido!
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
                ...
                <div class="invoice-action-tax-fields">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group mb-4">
                                <input type="text" class="form-control form-control-sm flatpickr-input" id="date"
                ...
                <div class="row">
                    <div class="col-xl-12 col-md-4">
                        <a href="javascript:void(0);" wire:click="store()"
                            ...
                            <div wire:loading wire:target="store" class="spinner-border text-white mr-2 align-self-center loader-sm ">Loading...</div>
                            Guardar
                        </a>
                    </div>
                    <div class="col-xl-12 col-md-4">
